  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg border p-6 space-y-3">
        ...
        <a
          href={`${API_BASE}/google/auth/login?clientId=shared&returnUrl=${encodeURIComponent(typeof window !== "undefined" ? `${window.location.origin}/onboarding?calendar=connected` : "https://sellient.netlify.app/onboarding?calendar=connected")}`}
